...
(
	...
	SURVEY_ACCESS_WORD VARCHAR(6) NOT NULL,
	DATE_MODIFIED TIMESTAMP DEFAULT NOW() NOT NULL,
	
	FOREIGN KEY (USER_ID) REFERENCES ADMINISTRATOR_ACCOUNT (USER_ID)
);
...
(
	USER_ID INT NOT NULL REFERENCES ADMINISTRATOR_ACCOUNT (USER_ID),
	SECURITY_ID INT NOT NULL REFERENCES SECURITY_ROLE (SECURITY_ID),
	DATE_MODIFIED TIMESTAMP DEFAULT NOW() NOT NULL,
...
(
	...
	FOREIGN KEY (MODIFIED_BY) REFERENCES ADMINISTRATOR_ACCOUNT (USER_ID)
);
...
(
	...
	FOREIGN KEY (CREATED_BY) REFERENCES ADMINISTRATOR_ACCOUNT (USER_ID),
	FOREIGN KEY (FORMAT_ID) REFERENCES QUESTION_FORMAT (FORMAT_ID),
	FOREIGN KEY (TOPIC_ID) REFERENCES QUESTION_TOPIC (TOPIC_ID)
);
...
(
	...
	FOREIGN KEY (AGE_ID) REFERENCES AGE (AGE_RANGE_ID),
	FOREIGN KEY (UNIT_ID) REFERENCES UNIT (UNIT_ID),
	FOREIGN KEY (MEAL_ID) REFERENCES MEAL (MEAL_ID),
	FOREIGN KEY (PARTICIPANT_TYPE_ID) REFERENCES PARTICIPANT (PARTICIPANT_TYPE_ID),
...
(
	QSELECTION_ID SERIAL PRIMARY KEY NOT NULL,
	QUESTION_ID INT NOT NULL,
	QSELECTION_TEXT VARCHAR(100) NOT NULL,
	QSELECTION_VALUE VARCHAR(100) NOT NULL,
...
-- Create Webmaster
INSERT INTO ADMINISTRATOR_ACCOUNT (USERNAME, ADMIN_PASSWORD, FIRST_NAME, LAST_NAME, ACTIVE_YN, DATE_CREATED, DATE_MODIFIED)
VALUES ('Webmaster', 'password', 'Web', 'Master', 'Y', Now(), NOW());