...
public partial class UserControls_MessageUserControl : System.Web.UI.UserControl
{
    ...
    private const string STR_TITLE_ICON_warning = "fas fa-exclamation-triangle";
    private const string STR_PANEL_danger = "alert alert-danger";
    private const string STR_TITLE_ICON_info = "fas fa-info-circle";
    private const string STR_PANEL_info = "alert alert-info";
    private const string STR_TITLE_ICON_success = "fas fa-check-circle";
