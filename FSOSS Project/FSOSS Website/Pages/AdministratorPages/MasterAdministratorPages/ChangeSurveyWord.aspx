<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeSurveyWord.aspx.cs" Inherits="Pages_ParticpantSampleCRUD" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card container">
                ...
                <asp:ListView runat="server" DataSourceID="SurveyWordODB">
                                ...
                                <td runat="server">
                                    <table runat="server" id="itemPlaceholderContainer" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
                                        <tr runat="server" style="background-color: #E0FFFF; color: #333333;">
                                            <th runat="server">surveyWordID</th>
                                            <th runat="server">surveyWord</th>
                                        </tr>
                ...
                <asp:ObjectDataSource ID="SurveyWordODB" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAllSurveyWord" TypeName="FSOSS.System.BLL.PotentialSurveyWordController"></asp:ObjectDataSource>
               sss
            </div>
        </div>
    </div>
