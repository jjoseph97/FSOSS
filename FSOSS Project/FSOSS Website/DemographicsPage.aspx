<%@ Page Title="Customer Profile & Contact Requests" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DemographicsPage.aspx.cs" Inherits="Pages_Survey_DemographicsPage" %>
    ...
    <div id="CustomerProfileContent" runat="server">
        <div class="row">
            ...
            <asp:DropDownList ID="GenderDDL" CssClass="col-md-4 form-control" runat="server" DataSourceID="GenderObjectDataSource"
                ...
                <asp:ListItem Text="Prefer not to answer" Value="1" />
            </asp:DropDownList>
